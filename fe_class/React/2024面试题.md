...
- 已经没有以前的 compoennt 了，均使用 element
...
对于 React 来说，去解析 jsx 的语法，主要依靠的事 babel
@babel/preset-react
...
setInterval 行程了一个闭包
- react hook 是一个链表的形式，它执行逻辑依赖于 deps 

解法：
1. ref , 因为ref在react是一个全局变量
2. state 以函数的形式执行

### 28. 在 react 中，如何实现渲染控制 | useMemo
